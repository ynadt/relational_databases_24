...
-- If there exists a unique constraint on the combination of first_name and last_name,
-- we could use the following query to insert the actors:
-- INSERT INTO actor (first_name, last_name)
-- VALUES
--     ('Casey', 'Affleck'),
--     ('Michelle', 'Williams'),
...
-- Link actors to the film "Manchester by the Sea" using subqueries
...
-- First, get the film_id
SELECT film_id
FROM film
WHERE title = 'Manchester by the Sea';

-- Then, check the film_actor table
